<x-filament-panels::page>
    <div class="space-y-6">
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total Films</dt>
                                <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $processingStats['total_movies'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $processingStats['pending_analysis'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $processingStats['in_processing'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $processingStats['validated'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white mb-4">Films DCP</h3>
                {{ $this->table }}
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function startBulkAnalysis() {
            if (confirm('Démarrer l\'analyse en lot pour tous les films en attente ?')) {
                alert('Analyse en lot démarrée (fonctionnalité en développement)');
            }
        }

        function generateReports() {
            alert('Génération de rapports (fonctionnalité en développement)');
        }

        function cleanupFiles() {
            if (confirm('Nettoyer les fichiers temporaires et les uploads expirés ?')) {
                alert('Nettoyage démarré (fonctionnalité en développement)');
            }
        }

        function exportMetadata() {
            alert('Export des métadonnées (fonctionnalité en développement)');
        }
    </script>
    @endpush
</x-filament-panels::page>
