<?php $__env->startSection('title', 'Contact - DCPrism'); ?>
<?php $__env->startSection('meta_description', 'Contactez l\'équipe DCPrism pour une démonstration, des questions techniques ou des informations sur nos solutions de gestion DCP pour festivals.'); ?>
                    ...
                    <div class="mb-6 bg-green-50 border border-green-200 rounded-lg p-4">
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <p class="text-green-600 text-sm mt-1"><?php echo e(session('success')); ?></p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <p class="text-red-600 text-sm mt-1"><?php echo e(session('error')); ?></p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                
                <form action="<?php echo e(route('showcase.contact.submit')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="subject" 
                                name="subject" 
                                required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="demo" <?php echo e(old('subject') == 'demo' ? 'selected' : ''); ?>>Demande de démonstration</option>
                            <option value="pricing" <?php echo e(old('subject') == 'pricing' ? 'selected' : ''); ?>>Informations tarifaires</option>
                            <option value="technical" <?php echo e(old('subject') == 'technical' ? 'selected' : ''); ?>>Question technique</option>
                            <option value="partnership" <?php echo e(old('subject') == 'partnership' ? 'selected' : ''); ?>>Partenariat</option>
                            <option value="support" <?php echo e(old('subject') == 'support' ? 'selected' : ''); ?>>Support utilisateur</option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea id="message" 
                                  ...
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php echo $__env->make('layouts.showcase', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/showcase/contact.blade.php ENDPATH**/ ?>