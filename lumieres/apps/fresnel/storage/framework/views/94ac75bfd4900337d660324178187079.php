<?php $__env->startSection('title', 'Fonctionnalités - DCPrism'); ?>
<?php $__env->startSection('meta_description', 'Découvrez toutes les fonctionnalités de DCPrism : upload sécurisé, validation technique DCI, gestion multi-festivals, tableau de bord temps réel et bien plus.'); ?>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-indigo-100 rounded-2xl p-8">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div class="bg-white rounded-lg p-4 text-center">
                            <div class="text-2xl font-bold text-purple-600"><?php echo e($stats['total_movies'] ?? '0'); ?></div>
                            <div class="text-sm text-gray-600">Films traités</div>
                        </div>
                        <div class="bg-white rounded-lg p-4 text-center">
                            <div class="text-2xl font-bold text-blue-600"><?php echo e($stats['validated_movies'] ?? '0'); ?></div>
                            <div class="text-sm text-gray-600">Validés</div>
                        </div>
                        <div class="bg-white rounded-lg p-4 text-center">
                            <div class="text-2xl font-bold text-green-600"><?php echo e($stats['total_festivals'] ?? '0'); ?></div>
                            <div class="text-sm text-gray-600">Festivals actifs</div>
                        </div>
                        <div class="bg-white rounded-lg p-4 text-center">
                            <div class="text-2xl font-bold text-orange-600"><?php echo e($stats['processing_movies'] ?? '0'); ?></div>
...
<?php echo $__env->make('layouts.showcase', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/showcase/features.blade.php ENDPATH**/ ?>