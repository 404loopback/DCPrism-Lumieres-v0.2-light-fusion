...
@section('title', 'DCPrism - Plateforme professionnelle de gestion DCP')
@section('meta_description', 'DCPrism facilite la gestion des Digital Cinema Package (DCP) pour les festivals de cinéma. Upload, validation technique automatisée, distribution sécurisée et tableau de bord temps réel.')
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20 fade-in">
            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">
                <div class="text-3xl font-bold text-white" id="stat-movies">{{ $stats['total_movies'] }}</div>
                <div class="text-blue-200 mt-2">Films traités</div>
            </div>
            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">
                <div class="text-3xl font-bold text-white" id="stat-festivals">{{ $stats['total_festivals'] }}</div>
                <div class="text-blue-200 mt-2">Festivals actifs</div>
            </div>
            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">
                <div class="text-3xl font-bold text-white" id="stat-validated">{{ $stats['validated_movies'] }}</div>
                <div class="text-blue-200 mt-2">Films validés</div>
            </div>
            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">
                <div class="text-3xl font-bold text-white" id="stat-storage">{{ $stats['storage_used'] }}</div>
                    ...
                    <div class="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-8 text-white">
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            <div class="bg-white/20 rounded-lg p-4 text-center">
                                <div class="text-2xl font-bold">{{ $stats['processing_movies'] ?? 0 }}</div>
...
<script>
    ...
    setInterval(function() {
        fetch('{{ route("showcase.api.stats") }}')
