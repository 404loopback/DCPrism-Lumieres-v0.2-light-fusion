        ...
        <div class="border-b border-gray-200 dark:border-gray-700">
            <nav class="flex space-x-8" aria-label="Tabs">
                <button 
                    ...
                    @svg('heroicon-o-users', 'w-4 h-4 inline mr-2') Utilisateurs
                </button>
                <button 
                    ...
                    @svg('heroicon-o-trophy', 'w-4 h-4 inline mr-2') Festivals
                </button>
                <button 
                    ...
                    @svg('heroicon-o-language', 'w-4 h-4 inline mr-2') Langues
                </button>
                <button 
                    ...
                    @svg('heroicon-o-queue-list', 'w-4 h-4 inline mr-2') Nomenclatures
                </button>
                <button 
                    ...
                    @svg('heroicon-o-cog-6-tooth', 'w-4 h-4 inline mr-2') Paramètres
                </button>
                <button 
                    ...
                    @svg('heroicon-o-shield-check', 'w-4 h-4 inline mr-2') Rôles & Permissions
                </button>
            </nav>
        </div>
