...
namespace Modules\Fresnel\app\Filament\Festival\Resources\Movies\Schemas;
                ...
                Section::make('Informations du film')
                    ...
                    ->schema([
                        TextInput::make('title')
                            ...
                            ->maxLength(255)
                            ->live(onBlur: true)
                            ->afterStateUpdated(fn ($state, $set) => $set('computed_nomenclature', self::generatePreviewNomenclature($state))
                            ),
