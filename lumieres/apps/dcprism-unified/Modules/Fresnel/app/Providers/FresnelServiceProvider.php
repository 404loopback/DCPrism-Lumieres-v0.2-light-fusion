...
namespace Modules\Fresnel\app\Providers;
...
class FresnelServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Fresnel';

    protected string $nameLower = 'fresnel';
