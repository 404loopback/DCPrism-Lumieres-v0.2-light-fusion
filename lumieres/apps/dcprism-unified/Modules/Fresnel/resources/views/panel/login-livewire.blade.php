...
<!-- Login Container -->
<div class="login-container" style="position: fixed; top: 0; left: 0; width: 100%; height: 100vh; background: #0a0a0a; display: flex; align-items: center; justify-content: center; font-family: 'Figtree', sans-serif; padding: 1.5rem;">
    <style>
        body {
            min-height: 100vh;
            position: relative;
