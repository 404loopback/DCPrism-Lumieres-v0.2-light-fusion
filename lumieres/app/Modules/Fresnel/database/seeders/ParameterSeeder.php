...
namespace Modules\Fresnel\Database\Seeders;
    ...
    public function run(): void
    {
        ...
        $contentParameters = [
            [
                ...
                'category' => Parameter::CATEGORY_CONTENT,
        ...
        $subtitleParameters = [
            [
                ...
                'code' => 'SUBTITLE_LANG',
                'type' => Parameter::TYPE_STRING,
                'category' => Parameter::CATEGORY_SUBTITLE,
        ...
        $accessibilityParameters = [
            [
                ...
                'category' => Parameter::CATEGORY_ACCESSIBILITY,
        ...
        // Créer les paramètres en base de données
